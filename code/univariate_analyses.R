...
shapesamp = NULL
for(i in 1:nbot){
  shapesamp[i] = median(sample(flo$dP[which(flo$tg2=="shape")], replace=T))
}
sd(shapesamp)

fitsamp = NULL
for(i in 1:nbot){
  fitsamp[i] = median(sample(flo$dP[which(flo$tg2=="fit")], replace=T))
}
sd(fitsamp)

displaysamp = NULL
for(i in 1:nbot){
  displaysamp[i] = median(sample(flo$dP[which(flo$tg2=="display")], replace=T))
}
sd(displaysamp)
