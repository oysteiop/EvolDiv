...
save(mod, file="./analyses/walter2018/Dmat75k.RData")
...
load(file="./analyses/walter2018/Dmat75k.RData")
n=10
...
pmat = cov(Gdat[Gdat$Type=="Dune", 8:17])
...
plot(log10(var_g_g), log10(var_d_g), 
     ...
     main="Senecio pimpinellifolium: Table", las=1)
